  ...
  export const About = () => {
    ...
    return (
      <section
        id="about"
        className="min-h-screen py-20 flex flex-col items-center bg-[#dce6f6]"
      >
        <RevealOnScroll>
          {/* Logo Ticker */}
          ...
          <motion.div
            ...
            className="w-full max-w-full mx-auto py-10 flex flex-col items-center p-6 bg-[#dce6f6]/60 backdrop-blur-md rounded-2xl border border-white/20"
          >
            {/* Photo and text side by side */}
              ...
              {/* Text */}
              <div className="flex-1 max-w-1xl text-center md:text-left justify-right pl-40 pr-10 0">
                {/* Heading */}
                <div className="mb-8 flex items-center gap-30 md:justify-start justify-center">
                  <h2 className="text-7xl font-extrabold text-[#3B5A8B] text-center md:text-left">
                    About Me
                  </h2>
                </div>
                <h3 className="text-2xl font-normal text-slate-800 mb-4">
                  Hi <span className="wave-hand">👋</span>, I'm <span className="font-bold"> Bao!</span>
                </h3>
                <p className="text-[20px] text-gray-900 text-lg leading-relaxed mb-4 text-justify mr-90">
                  I am a Sydney-based Computer Science student with big dreams, decent biceps, and an even bigger love for building cool stuff with code. 
